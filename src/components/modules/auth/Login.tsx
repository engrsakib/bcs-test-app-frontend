...
// import React, { useState } from "react";
// import { useRouter } from "next/navigation";
// import { Phone, Lock, Eye, EyeOff, LogIn, AlertCircle, Home } from "lucide-react";
// import Link from "next/link";
...
//       //   }, 1200);
//       // } else {
//       //   Swal.fire("Failed", data.message || "Login failed", "error");
//       // }
...
//         <div className="relative h-32 bg-gradient-to-br from-green-600 via-green-700 to-emerald-700 flex items-center justify-center">
//           <LogIn className="w-12 h-12 text-white mb-2" strokeWidth={2} />
//           <div className="text-center">
//             <h2 className="text-2xl font-bold text-white">Login</h2>
//             <p className="text-green-100 text-sm">BCS Exam Portal</p>
//           </div>
//         </div>
...
//             type="button"
//             onClick={handleSubmit}
//             className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3.5 rounded-xl shadow-lg flex items-center justify-center gap-2"
//           >
...
//             Don't have an account?
//             <Link href="/dashboard/auth/register">
//               <button className="ml-2 text-green-700 hover:underline font-semibold">
//                 Register
//               </button>
//             </Link>
//           </p>
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res:any =await await fetch("/api/v1/admin/login", {
  method: "POST",
  headers: { "Content-Type": "application/json" },
  credentials: "include",
  body: JSON.stringify(formData),
