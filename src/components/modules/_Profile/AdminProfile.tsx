...
export default function AdminProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="relative px-6 sm:px-8 pb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end -mt-16 sm:-mt-20 mb-6">
              ...
              <div className="mt-4 sm:mt-0 sm:ml-6 flex-1 text-center sm:text-left translate-y-6">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">{adminData?.name}</h2>
                <p className="text-green-800 font-medium text-lg capitalize">{adminData?.role}</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Designation</p>
                    <p className="text-gray-900 font-medium">{adminData?.designation}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Joined</p>
                    <p className="text-gray-900 font-medium">{formatDate(adminData?.createdAt || '')}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Bio */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Biography</h3>
                <p className="text-gray-700 leading-relaxed">{adminData?.bio || "No biography added."}</p>
              </div>
            </div>

            {/* Permissions List */}
            <div className="mt-8">
              <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 mb-4">Permissions</h3>
              ...
              {adminData?.permissions?.length ? (
                ...
                <p className="text-gray-500 text-center">No permissions available</p>
              )}
            </div>
          </div>
        </div>
      ...
      {/* UPDATE MODAL */}
      {/* ------------------------ */}
      {isModalOpen && hasPermission("edit_profile") && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <button
                onClick={handleUpdateProfile}
                disabled={updating}
                className="w-full bg-green-800 text-white py-3 rounded-lg mt-4"
              >
                {updating ? "Updating..." : "Update Profile"}
              </button>
