...
// import MathEditor from '../permission/MathEditor';


// // ... আপনার Input এবং Select কম্পোনেন্ট (এগুলো ঠিক আছে) ...
...
//   // ... আপনার handleSubmit ফাংশন (এটি ঠিক আছে) ...
...
//     setAllQuestions((prevQuestions) => [newQuestion, ...prevQuestions]); 
...
//                     {/* অপশনের text দিয়ে ডায়নামিকভাবে অপশন তৈরি করা */}
//                     {blank.options.map((opt, index) => (
//                       // শুধু যদি অপশনে কিছু লেখা থাকে তবেই এটি দেখাবে
//                       opt && (
...
//       {/* --- ডেমো সেকশন (নিচে দেখানোর জন্য) --- */}
//       <div className="max-w-4xl mx-auto mt-12">
//         <h2 className="text-2xl font-bold text-gray-900 mb-6">
//           Added Questions (Demo)
//         </h2>
...
//                     <MathEditor value={q.mathFormula} onChange={() => {}} />
//                   </div>
//                 )}
...
//                       <div key={bIndex} className="pl-4 border-l-2 border-blue-500">
//                         <p className="font-semibold">Blank {bIndex + 1}:</p>
//                         <ul className="list-disc list-inside text-gray-600">
//                           {blank.options.map((opt, oIndex) => (
//                             <li key={oIndex} className={blank.correctAnswer == (oIndex + 1) ? 'font-bold text-green-600' : ''}>
//                               {opt} {blank.correctAnswer == (oIndex + 1) && '(Correct)'}
//                             </li>
//                           ))}
//                         </ul>
//                       </div>
...
// LocalStorage Key (CreateExamForm-er sathe MELA RAKHUN)
const QUESTIONS_STORAGE_KEY = 'allQuestions';

// ... Input এবং Select helper component-gulo (ager motoi)...
const Input = ({ label, ...props }) => (
  <div>
    <label className="block text-sm font-medium text-gray-700 mb-1">
      {label}
