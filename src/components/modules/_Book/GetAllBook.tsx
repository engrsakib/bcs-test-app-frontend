...
//         `${BASE_URL}?page=${page}&limit=${limit}&searchTerm=${search}`,
//         {
//           headers: {
//             Authorization: token || "",
//           },
...
//       // ⭐ ALWAYS MAKE SURE books IS AN ARRAY ⭐
//       const safeBooks = [
//         ...(response?.data?.data ||
//           response?.data ||
//           response ||
...
//     try {
//       const res = await fetch(`${BASE_URL}/${book_number}`, {
//         method: "DELETE",
//         headers: {
//          Authorization: token || "",
//         },
...
//             ) : books.length === 0 ? (
//               <tr>
//                 <td colSpan={6} className="text-center py-6 text-gray-500">No books found</td>
//               </tr>
//             ) : (
//               books.map((book) => (
...
//   // ============================================
//   // ENUM PLATFORM BADGE (GRADIENT STYLE)
//   // ============================================
...
//             ) : books.length === 0 ? (
//               <tr>
//                 <td colSpan={8} className="text-center py-6 text-gray-500">No books found</td>
//               </tr>
//             ) : (
//               books.map((book) => (
//                 <tr key={book.book_number} className="border-b hover:bg-gray-50">
...
//                   {/* ID */}
//                   <td className="text-center py-4 font-semibold">{book.book_number}</td>
